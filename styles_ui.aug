...
<!-- ##### Styles - Action Portals/Buttons ##### -->
  ...
  <!-- style used on the fatigue damage button - bitmap-only with no text -->
  <style
    id="actFatDmg">
    <style_action
      textcolorid="clrnormal"
      font="fntactsml"
      up="actftdmgu" down="actftdmgd" off="actftdmgo">
      </style_action>
    <resource
      id="actftdmgu"
      isbuiltin="yes">
  ...
  <style
    ...
    <style_action
      textcolorid="clrnormal"
      font="fntactsml"
      up="actftdmtcu" down="actftdmtcd" off="actftdmtcu">
      </style_action>
    <resource
      id="actftdmtcu"
      isbuiltin="yes">
  ...
  <style
    ...
    <style_action
      textcolorid="clrnormal"
      font="fntactsml"
      up="actfthlup" down="actfthldn" off="actfthlof">
      </style_action>
    <resource
      id="actfthlup"
      isbuiltin="yes">
  ...
  <style
    ...
    <style_action
      textcolorid="clrnormal"
      font="fntactsml"
      up="actftunup" down="actftundn" off="actftunof">
      </style_action>
    <resource
      id="actftunup"
      isbuiltin="yes">
  ...
  <style
    ...
    <style_action
      textcolorid="clrnormal"
      font="fntactsml"
      up="actftresup" down="actftresdn" off="actftresof">
      </style_action>
    <resource
      id="actftresup"
      isbuiltin="yes">
